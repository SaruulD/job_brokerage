...
class EditJob extends React.Component {
    ...
    componentDidMount() {
        ...
        actions.JobById(job_id).then((res) => {
            console.log(res);
            this.setState({
                jobId: job_id,
                ...
                selectCatList: res.data.category_id,
                selectTypeList: res.data.job_type_id,
                selectCompanyList: res.data.company.id,
            });
        });
    }
    ...
    editJob = (event) => {
        actions
            ...
            .then((res) => {
                if (res.data != null) {
                    history.push(
                        `/viewcompany/${this.state.selectCompanyList}`
                    );
                }
            })
            .catch((err) => {
                    ...
                    <Card.Body>
                        <Form.Row>
                            <Form.Group as={Col} controlId="formGridState">
                                ...
                                <Form.Control
                                    disabled
                                    as="select"
                                    value={this.state.selectCompanyList}
                        ...
                        <Form.Row>
                            <Form.Group as={Col} controlId="formGridState">
                                ...
                                <Form.Control
                                    as="select"
                                    value={this.state.selectCatList}
                        ...
                        <Form.Row>
                            ...
                            <Form.Group as={Col} controlId="postjob_jobType">
                                ...
                                <Form.Control
                                    ...
                                    value={this.state.selectTypeList}
